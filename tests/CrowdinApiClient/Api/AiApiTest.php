...
class AiApiTest extends AbstractTestApi
{
    ...
    public function testCreateFineTuningDataset(): void
    {
        ...
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/datasets',
            'method' => 'post',
            'body' => json_encode($params),
            'response' => '{
              "data": {
        ...
        $dataset = $this->crowdin->ai->createFineTuningDataset(1, 2, $params);
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/datasets/50fb3506-4127-4ba8-8296-f97dc7e3e0c3',
            'method' => 'get',
            'response' => '{
              "data": {
                "identifier": "50fb3506-4127-4ba8-8296-f97dc7e3e0c3",
        ...
        $dataset = $this->crowdin->ai->getFineTuningDataset(1, 2, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
        $this->assertInstanceOf(AiFineTuningDataset::class, $dataset);
        $this->assertEquals('finished', $dataset->getStatus());
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/datasets/50fb3506-4127-4ba8-8296-f97dc7e3e0c3/download',
            'method' => 'get',
            'response' => '{
              "data": {
                "url": "https://production-enterprise-importer.downloads.crowdin.com/992000002/2/14.xliff",
        ...
        $download = $this->crowdin->ai->downloadFineTuningDataset(1, 2, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
        $this->assertInstanceOf(DownloadFile::class, $download);
        $this->assertEquals('https://production-enterprise-importer.downloads.crowdin.com/992000002/2/14.xliff', $download->getUrl());
        $this->assertEquals('2019-09-20T10:31:21+00:00', $download->getExpireIn());
    }
    ...
    public function testCreateFineTuningJob(): void
    {
        ...
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/jobs',
            'method' => 'post',
            'body' => json_encode($params),
            'response' => '{
              "data": {
        ...
        $job = $this->crowdin->ai->createFineTuningJob(1, 2, $params);
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/jobs/50fb3506-4127-4ba8-8296-f97dc7e3e0c3',
            'method' => 'get',
            'response' => '{
              "data": {
                "identifier": "50fb3506-4127-4ba8-8296-f97dc7e3e0c3",
                ...
                "attributes": {
                  ...
                  "trainingOptions": {
                    ...
                    "dateTo": "2019-09-23T11:26:54+00:00",
                    "maxFileSize": null,
                    "minExamplesCount": null,
                    "maxExamplesCount": null
                  },
                  "validationOptions": {
                    "projectIds": null,
                    "tmIds": null,
        ...
        $job = $this->crowdin->ai->getFineTuningJob(1, 2, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
        $this->assertInstanceOf(AiFineTuningJob::class, $job);
        $this->assertEquals('finished', $job->getStatus());
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/fine-tuning/jobs',
            'method' => 'get',
            'response' => '{
              "data": [
                {
        ...
        $jobs = $this->crowdin->ai->listFineTuningJobs(1);
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/prompts/2/fine-tuning/jobs/50fb3506-4127-4ba8-8296-f97dc7e3e0c3/events',
            'method' => 'get',
            'response' => '{
              "data": [
                {
        ...
        $events = $this->crowdin->ai->listFineTuningJobEvents(1, 2, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/settings/custom-placeholders',
            'method' => 'get',
            'response' => '{
              "data": [
                {
        ...
        $placeholders = $this->crowdin->ai->listCustomPlaceholders(1);
    ...
    public function testCreateCustomPlaceholder(): void
    {
        ...
        $placeholder = $this->crowdin->ai->createCustomPlaceholder(1, $params);
    ...
    {
        $this->mockRequest([
            'path' => '/users/1/ai/settings/custom-placeholders/2',
            'method' => 'get',
            'response' => '{
              "data": {
                "id": 2,
        ...
        $placeholder = $this->crowdin->ai->getCustomPlaceholder(1, 2);
        $this->assertInstanceOf(AiCustomPlaceholder::class, $placeholder);
        $this->assertEquals(
    ...
    public function testDeleteCustomPlaceholder(): void
    {
        ...
        $this->crowdin->ai->deleteCustomPlaceholder(1, 2);
    }
