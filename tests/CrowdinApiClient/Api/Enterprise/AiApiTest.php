...
class AiApiTest extends AbstractTestApi
{
    ...
    public function testListRequestLogs(): void
    {
        ...
        $requestLogs = $this->crowdin->ai->listRequestLogs([
            'requestId' => '9d3b1c4e-2f3a-4b5c-8d6e-7f8a9b0c1d2e',
            'projectId' => 8,
            'userId' => 42,
            'aiProviderId' => 3,
