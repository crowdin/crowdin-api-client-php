...
class AiGatewayApiTest extends AbstractTestApi
{
    ...
    {
        $this->mockRequest([
            'path' => '/ai/providers/2/gateway/chat/completions',
            'method' => 'get',
            'response' => '{
              "data": {
                "id": "chatcmpl-abc123",
        ...
        $response = $this->crowdin->aiGateway->gatewayGet(2, 'chat/completions');
    ...
    public function testGatewayPost(): void
    {
        ...
        $response = $this->crowdin->aiGateway->gatewayPost(2, 'chat/completions', $data);
        $this->assertInstanceOf(AiGatewayResponse::class, $response);
        $this->assertEquals('chatcmpl-abc123', $response->getData()['id']);
    }
    ...
    public function testGatewayPut(): void
    {
        ...
        $response = $this->crowdin->aiGateway->gatewayPut(2, 'chat/completions', $data);
        $this->assertInstanceOf(AiGatewayResponse::class, $response);
        $this->assertEquals('chatcmpl-abc123', $response->getData()['id']);
    }
    ...
    public function testGatewayPatch(): void
    {
        ...
        $response = $this->crowdin->aiGateway->gatewayPatch(2, 'chat/completions', $data);
        $this->assertInstanceOf(AiGatewayResponse::class, $response);
        $this->assertEquals('chatcmpl-abc123', $response->getData()['id']);
    }
    ...
    public function testGatewayDelete(): void
    {
        ...
        $response = $this->crowdin->aiGateway->gatewayDelete(2, 'chat/completions');
        $this->assertInstanceOf(AiGatewayResponse::class, $response);
        $this->assertEquals('chatcmpl-abc123', $response->getData()['id']);
    }
}
