...
class ReportArchiveApiTest extends AbstractTestApi
{
    ...
    public function testList()
    {
        ...
        $reportArchives = $this->crowdin->reportArchive->list();
    ...
    public function testGet()
    {
        ...
        $reportArchive = $this->crowdin->reportArchive->get(12);
    ...
    {
        $this->mockRequestDelete('/reports/archives/12');
        $this->crowdin->reportArchive->delete(12);
    }
    ...
    public function testExport()
    {
        $params = [];
        $this->mockRequest([
            'path' => '/reports/archives/12/exports',
            'method' => 'post',
        ...
        $export = $this->crowdin->reportArchive->export(12);
    ...
    {
        $this->mockRequestGet('/reports/archives/12/exports/50fb3506-4127-4ba8-8296-f97dc7e3e0c3', '{
          "data": {
            "identifier": "50fb3506-4127-4ba8-8296-f97dc7e3e0c3",
            "status": "finished",
            "progress": 100,
        ...
        $export = $this->crowdin->reportArchive->checkExportStatus(12, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
    ...
    {
        $this->mockRequestGet('/reports/archives/12/exports/50fb3506-4127-4ba8-8296-f97dc7e3e0c3/download', '{
          "data": {
        ...
        $downloadFile = $this->crowdin->reportArchive->downloadReportArchive(12, '50fb3506-4127-4ba8-8296-f97dc7e3e0c3');
