...
class TaskApi extends AbstractApi
{
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.getMany API Documentation Enterprise
     *
     * @param int $projectId
     * @param array $params
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.get API Documentation Enterprise
     *
     * @param int $projectId
     * @param int $taskId
     * @return Task|null
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.post API Documentation Enterprise
     *
     * @param int $projectId
     * @param array $data
     * @return Task|null
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.patch API Documentation Enterprise
     *
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.delete API Documentation Enterprise
     *
     * @param int $projectId
     * @param int $taskId
     * @return mixed
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.tasks.export.get API Documentation Enterprise
     *
     * @param int $projectId
     * @param int $taskId
    ...
    /**
     * List User Tasks
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.user.tasks.getMany API Documentation Enterprise
     *
     * @param array $params
     * integer $params[limit]  [ 1 .. 500 ] Default: 25<br>
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.user.tasks.patch API Documentation Enterprise
     *
     * @param int $taskId
     * @param int $projectId
