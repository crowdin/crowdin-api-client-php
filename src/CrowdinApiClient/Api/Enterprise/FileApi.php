...
class FileApi extends CrowdinFileApi
{
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.strings.reviewed-builds.getMany API Documentation Enterprise
     *
     * @param int $projectId
     * @param array $params
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.strings.reviewed-builds.post API Documentation Enterprise
     *
     * @param int $projectId
     * @param array $data
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.strings.reviewed-builds.get API Documentation Enterprise
     *
     * @param int $projectId
     * @param int $buildId
     * @return ReviewedSourceFileBuild
