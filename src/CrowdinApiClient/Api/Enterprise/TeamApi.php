...
class TeamApi extends AbstractApi
{
    /**
     * Add Team ToProject
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.teams.post API Documentation
     *
     * @param int $projectId
     * @param array $data
    ...
    /**
     * List Teams
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.teams.getMany API Documentation
     *
     * @param array $params
    ...
    /**
     * Add Team
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.teams.post API Documentation
     *
     * @param array $data
     * string $data[name]
     * @return Team
    ...
    /**
     * Get Team
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.teams.post
     *
     * @param int $teamId
     * @return Team
     */
    ...
    /**
     * Delete Team
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.teams.delete API Documentation
     *
     * @param int $teamId
     * @return mixed
     */
