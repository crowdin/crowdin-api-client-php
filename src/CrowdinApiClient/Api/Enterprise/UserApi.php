...
class UserApi extends AbstractApi
{
    /**
     * Add Project Member
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.members.post API Documentation
     *
     * @param int $projectId
     * @param array $data
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.members.getMany API Documentation
     *
     * @param int $projectId
     * @param array $data
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.members.put API Documentation
     *
     * @param int $projectId
     * @param int $memberId
     * @param array $data
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.projects.members.delete API Documentation
     *
     * @param int $projectId
     * @param int $memberId
     */
    ...
    /**
     * List Users
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.users.getMany API Documentation
     *
     * @param array $params
     * @return ModelCollection
     */
    ...
    /**
     * Get User Info
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.users.getById API Documentation
     *
     * @param int $userId
     * @return User|null
     */
     ...
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.user.get API Documentation
     *
    ...
    /**
     * Invite User
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.users.post API Documentation
     *
     * @param array $data
     * @return User
     */
    ...
    /**
     * Delete User
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.users.delete API Documentation
     *
     * @param int $userId
     * @return mixed
     */
    ...
    /**
     * Update User
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.users.patch API Documentation
     *
     * @param User $user
     * @return User
     */
