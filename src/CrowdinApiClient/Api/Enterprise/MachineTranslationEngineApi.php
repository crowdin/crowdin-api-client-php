...
class MachineTranslationEngineApi extends AbstractApi
{
    /**
     * List MTs
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.mts.getMany API Documentation
     *
     * @param array $params
    ...
    /**
     * Get MT
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.mts.get API Documentation
     *
     * @param int $mtId
    ...
    /**
     * Add MT
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.mts.post API Documentation
     *
     * @param array $data
    ...
    /**
     * Edit MT
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.mts.patch API Documentation
     *
    ...
    /**
     * Delete MT
     * @link https://developer.crowdin.com/enterprise/api/#operation/api.mts.delete API Documentation
     *
     * @param int $mtId
     * @return mixed
     */
