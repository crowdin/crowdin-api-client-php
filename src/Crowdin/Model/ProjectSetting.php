...
class ProjectSetting extends BaseModel
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->pseudoLanguageId = (integer)$this->getDataProperty('pseudoLanguageId');
     ...
     * @return int
     */
    public function getPseudoLanguageId(): int
    {
        return $this->pseudoLanguageId;
    }

    /**
     * @param int $pseudoLanguageId
     */
    public function setPseudoLanguageId(int $pseudoLanguageId): void
    {
